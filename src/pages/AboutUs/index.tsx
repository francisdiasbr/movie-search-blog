      ...
      <div className="container mx-auto p-4">
        <div className="flex flex-col md:flex-row items-center gap-8">
          ...
          <div className="flex-1 space-y-4">
            ...
            <p className="text-lg" style={{ marginBottom: '60px' }}>O blog é feito com muito carinho e dedicação em um trabalho que envolve a curadoria de filmes, catalogação e criação de conteúdo, mirando temáticas e diretores específicos (✨ MORE COMING SOON ✨).</p>
            
            <p className="text-lg">Seja bem-vindo(a) e aproveite as postagens e a curadoria de filmes, feitas especialmente por mim.</p>
            
            <p className="text-lg">No momento, o blog conta com a categoria de reviews. Em breve serão adicionadas novas categorias e novas postagens.</p>
